---
alias: '46f8de6bd6ec'
heroImage: /blog/posts/getting-started-with-relay-modern.png
authors: [nikolasburk]
---

import { PostTitle, Abstract } from 'gatsby-theme-coder-blog/src/components/Blog/Post/Metadata'

<PostTitle>Getting Started with Relay Modern</PostTitle>
...
[Realy Modern](https://facebook.github.io/relay/docs/relay-modern.html) is the very promising evolution and the 1.0-release of Facebook’s homegrown GraphQL client _Relay_. It was announced at this year’s F8 conference and officially released by Lee Byron during [his talk](https://www.youtube.com/watch?v=OdsMz7h_Li0) at React Europe.
...
On the backend, you’ll use a GraphQL API provided by Graphcool. As with create-react-app, you use the [Graphcool CLI](https://www.graph.cool/docs/reference/cli/overview-kie1quohli/) to generate it:
...
The remote schema file that you’re using here contains the following data model (written in [GraphQL SDL](https://www.graph.cool/docs/faq/graphql-sdl-schema-definition-language-kr84dktnp0/) syntax):
...
![](https://cdn-images-1.medium.com/max/2046/0*t5Y1tsH07bEQHbrB.)

Note that you can now manage this project in the [Graphcool Console](https://console.graph.cool/). If you want to manage it locally, you can use the [project file](https://www.graph.cool/docs/reference/cli/project-files-ow2yei7mew/) `project.graphcool` to make local changes to the schema and then apply them by calling `graphcool push`.
...
![](https://cdn-images-1.medium.com/max/2046/0*KQLRnImerQRjALS5.)
...
![](https://cdn-images-1.medium.com/max/2000/0*QelKIjXtM12d3kAe.)
...
Meet the [`QueryRenderer`](https://facebook.github.io/relay/docs/query-renderer.html): `QueryRenderer` is the root of a Relay tree. It takes a query, fetches the data and calls the `render` callback with the data.
...
![](https://cdn-images-1.medium.com/max/2000/0*iPceJCV7B-ri4upn.)

> **Note**: You can also use the [Data Browser](https://www.graph.cool/docs/reference/console/data-browser-och3ookaeb/) to add some post items.
...
![](https://cdn-images-1.medium.com/max/2000/0*A92lc0WjBQD120DC.)
...
> _Note that we’re only using version 2.8.1 to be consistent with our other [Quickstart](https://www.graph.cool/docs/quickstart) examples._
...
![](https://cdn-images-1.medium.com/max/2046/0*h_JXfmCfcMYpbO__.)
...
![](https://cdn-images-1.medium.com/max/2046/0*lWBTpLYdMBLe7BvS.)
...
![](https://cdn-images-1.medium.com/max/2000/0*p_mSrJU2L90IXDSi.jpg)
...
We hope you enjoyed learning about Relay Modern! If you have any questions, check out our [documentation](https://www.graph.cool/docs/tutorials/relay-modern-getting-started-woodito7ug/graph.cool/docs), join our [forum](https://www.graph.cool/forum/) or [Slack](https://slack.graph.cool/).
