...
alias: 'homihof6eifi'
heroImage: ''
metaImage: /blog/posts/heroku.png
authors: [nikolasburk]
---

import { PostTitle, Abstract } from 'gatsby-theme-coder-blog/src/components/Blog/Post/Metadata'
import { A, Paragraph, WideImage } from 'gatsby-theme-coder-blog/src/components/Blog/Post/styles'
import Youtube from 'gatsby-theme-coder-blog/src/components/Blog/Post/Youtube'

<PostTitle short="Instant Prisma deployment to Heroku">
  Instant Prisma server deployment with new Heroku integration
</PostTitle>

<Abstract>

Known for its simple workflows, [Heroku](https://www.heroku.com/) is one of the most popular PaaS
providers used by developers to deploy their apps. With the new Prisma Cloud integration, you can now deploy Prisma
to Heroku with one click.
