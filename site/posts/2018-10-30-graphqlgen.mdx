...
authors: [nikolasburk]
title: 'Introducing `graphqlgen`: Generate & scaffold type-safe resolvers based on your GraphQL schema'
---
...
import { Paragraph, A, InlineCode } from 'gatsby-theme-coder-blog/src/components/Blog/Post/styles'

<PostTitle>Introducing `graphqlgen`: Generate & scaffold type-safe resolvers based on your GraphQL schema</PostTitle>

<Abstract>
  [`graphqlgen`](https://github.com/prisma/graphqlgen) translates GraphQL schemas into type definitions and scaffolds resolver implementations.
  It lets you implement type-safe resolvers without the need for writing boilerplate. [Watch demo video](https://www.youtube.com/watch?v=6ZSF60zVFow).
</Abstract>
