---
alias: 'zie3iphithxy'
heroImage: /blog/posts/graphql-middleware.png
metaImage: /blog/posts/graphql-middleware.png
authors: [nikolasburk]
---
...
<PostTitle>Open Sourcing GraphQL Middleware - A Library to Simplify Your Resolvers</PostTitle>
...
<Button color="dark" type="primary" href="https://glitch.com/edit/#!/remix/graphql-middleware-demo" target="_blank">
  ▶ Run Example
</Button>
...
When using with `graphql-yoga`, the middleware functions can be passed directly into the `GraphQLServer` constructor. Other servers require you to create an [executable schema](https://docs-beta.prisma.io/1.13/understand-prisma/introduction-to-graphql-server-development-aa02/#schema-definition-vs-resolver-implementation) first and then _apply_ the middleware functions to it (using the `applyMiddleware` function as shown in the first example).
...
<Button color="dark" type="primary" href="https://www.github.com/prismagraphql/graphql-middleware" target="_blank">
  🌟 Star on GitHub 🌟
</Button>
